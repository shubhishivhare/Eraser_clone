    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="sm:flex sm:gap-4">
          <a
            className="block rounded-md px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-800"
            href="#"
          >
          ...
          <a
            className="hidden rounded-md bg-white px-5 py-2.5 text-sm font-medium text-gray-800 transition hover:text-gray-800 sm:block"
            href="#"
          >
